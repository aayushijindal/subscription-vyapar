            ...
            <div className="w-[400px] border border-border/60 rounded-xl overflow-hidden">
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="pt-4 flex items-center justify-end gap-4">
                  ...
                  <button onClick={handleSubmit} disabled={isSubmitting} className="bg-primary hover:bg-primary-hover text-white px-6 py-3 rounded-lg text-[12px] font-bold uppercase tracking-wider flex items-center gap-2 transition-colors disabled:opacity-50">
                    {isSubmitting ? <><Loader2 className="w-4 h-4 mr-2 animate-spin" /> Saving...</> : <><Save className="w-4 h-4" /> {editingId ? 'Update Purchase Bill' : 'Post Purchase Bill'}</>}
                  </button>
                </div>
              </div>
            </div>
