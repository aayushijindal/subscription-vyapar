...
export const Features: React.FC = () => {
  return (
    <div className="min-h-screen pt-28 pb-20 bg-input overflow-hidden relative">
      {/* Background aesthetics */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-primary-light/50 rounded-full blur-[100px] pointer-events-none -z-10" />

      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16 animate-rise">
          <span className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary-light px-3 py-1.5 text-xs font-bold text-primary mb-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, i) => {
            ...
            return (
              <div 
                key={i} 
                className="bg-surface rounded-[24px] p-8 border border-border/60 shadow-xl shadow-none hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 animate-rise group"
                style={{ animationDelay: `${i * 100}ms` }}
              >
                <div className="h-14 w-14 rounded-2xl bg-primary-light flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary transition-all duration-300">
