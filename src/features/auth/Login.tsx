  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h1 className="text-2xl font-bold text-slate-900">Log in to your workspace</h1>
        <p className="text-sm text-slate-500">Use the username and password registered for your company.</p>
      </div>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="space-y-1.5 text-left">
          ...
          <div className="relative">
            ...
            <input type="text" {...register('username')} placeholder="admin" className="w-full rounded-xl border border-slate-200 py-2.5 pl-10 pr-4 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20" />
          </div>
        ...
        <div className="space-y-1.5 text-left">
          <div className="flex justify-between">
            ...
            <Link to="/forgot-password" className="text-xs font-medium text-blue-600">Forgot Password?</Link>
          </div>
          <div className="relative">
      ...
      <p className="text-center text-sm text-slate-500">New to First Computer ERP? <Link to="/register" className="font-semibold text-blue-600">Register Company</Link></p>
    </div>
  );
};
